              ...
              <form action="/editRide" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="price" class="form-control" id="exampleInputEmail1" placeholder="Enter price" value={{ $data['price'] }}>
                  </div>
                    <div class="form-group">
                    <label for="exampleInputEmail1">UserId</label>
                    <input type="text" name="userIds" class="form-control" id="exampleInputEmail1" placeholder="Select user" value={{ $data['userIds'] }}>
                  </div>
                  <div class="form-group">
